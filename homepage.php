...
<body>
  ...
  <!----------Seção inicio com imagem---------->
  <section id="home_init">
    <div class="container-home">
      <h1>COMEÇE SEU TREINO HOJE!</h1>
      <div class="custom-btn-container">
        <a href="#aquecimento_home" class="aquecimento-btn">EXERCÍCIOS DE AQUECIMENTO</a>
      </div>
    </div>
  </section>
  <!-------------Seção aquecimentos----------->
  <section id="aquecimento_home">
    <h1 class="indices_secao"><i class="bi bi-chevron-right"></i>AQUECIMENTO</h1>
<div class="container my-5">
  <div class="row" id="modals-container-warmups">
  </div>
</div>

<!-- Modal HTML para aquecimentos -->
<div class="modal fade" id="gifModalWarmups" tabindex="-1" aria-hidden="true">
  <div class="modal-dialog modal-dialog-centered modal-lg">
    <div class="modal-content text-center p-3">
      <h3 id="modalTitleWarmups" class="font-weight-bold mb-3"></h3>
      <div id="modalMediaWarmups"></div> 
      <p id="modalDescriptionWarmups"></p>
      <button type="button" class="btn btn-danger text-dark" data-dismiss="modal">FECHAR</button>
        ...
        <section id="categorias_home">
          <div class="container-fluid">
            <h1 class="indices_secao"><i class="bi bi-chevron-right"></i>CATEGORIAS</h1>
        
            <div class="row g-6">
              <!-- Card 1 -->
              <div class="col-md-4">
                <a href="uppers.html" class="text-decoration-none">
                  <div class="categoria-card">
                    <img src="img/superiores_home.png" alt="Superiores">
                    <div class="categoria-title">Superiores</div>
                  </div>
                </a>
              </div>
              ...
              <!-- Card 2 -->
              <div class="col-md-4">
                <a href="lowers.html" class="text-decoration-none">
                  <div class="categoria-card">
                    <img src="img/inferiores_home.png" alt="Inferiores">
                    <div class="categoria-title">Inferiores</div>
                  </div>
                </a>
              </div>
              ...
              <!-- Card 3 -->
              <div class="col-md-4">
                <a href="backs.html" class="text-decoration-none">
                  <div class="categoria-card">
                    <img src="img/backs_home.png" alt="Costas">
                    <div class="categoria-title">Costas</div>
                  </div>
                </a>
              </div>
            </div>
