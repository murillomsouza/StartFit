...
<body>
      ...
      <div class="offcanvas offcanvas-end bg-custom text-white" tabindex="-1" id="offcanvasDarkNavbar"
        ...
        <div class="offcanvas-body">
          <ul class="navbar-nav justify-content-end flex-grow-1 pe-3">
            ...
            <li class="nav-item">
              <a class="nav-link active" href="lowers.php">Inferiores</a>
            </li>
            <li class="nav-item">
              <a class="nav-link" href="backs.php">Costas</a>
            </li>
  ...
  <!----------Seção inferiores]---------->
  <section id="exercicios_inferiores">
    <h1 class="indices_secao"><i class="bi bi-chevron-right"></i>INFERIORES</h1>
    <div class="container my-5">
      <div class="row" id="modals-container-lowers">

  <!-- Modal para Inferiores -->
  <div class="modal fade" id="gifModalLower" tabindex="-1" aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered modal-lg">
      <div class="modal-content text-center p-3">
        <h3 id="modalTitleLower" class="font-weight-bold mb-3"></h3>
        <div id="modalMediaLower" class="mb-3"></div>
        <p id="modalDescriptionLower"></p>
