const modals = [
  {
    title: "Cardio",
    staticImg: "gifs/cardio_static.jpg",
    gif: "gifs/cardio.gif",
    description: "Exercícios de cardio para iniciantes.",
    colorClass: "bg-primary"
  },
  {
    title: "Alongamento",
    staticImg: "gifs/alongamento_static.jpg",
    gif: "gifs/alongamento.gif",
    description: "Rotina de alongamentos para o corpo todo.",
    colorClass: "bg-info"
  },
  {
    title: "Força",
    staticImg: "gifs/forca_static.jpg",
    gif: "gifs/forca.gif",
    description: "Treino de força com peso corporal.",
    colorClass: "bg-warning"
  }
];

function createModalCard({ title, staticImg, gif, description, colorClass }, index) {
...
document.addEventListener("DOMContentLoaded", () => {
  ...
  // Repetir em trios
  for (let i = 0; i < modals.length; i += 3) {
    const rowGroup = document.createElement("div");
    rowGroup.className = "row w-100";
    for (let j = i; j < i + 3 && j < modals.length; j++) {
      rowGroup.appendChild(createModalCard(modals[j], j));
    }
